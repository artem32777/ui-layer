...
export const svgIconData = {
	...
	"chevronDown": {"attrs":{"xmlns":"http://www.w3.org/2000/svg","width":"12","height":"8","viewBox":"0 0 12 8","fill":"none"},"body":"\n    <path d=\"M1 1L6 6L11 1\" stroke=\"black\" stroke-width=\"2\" stroke-linecap=\"round\"/>\r\n"},
	"chevronRight": {"attrs":{"xmlns":"http://www.w3.org/2000/svg","width":"8","height":"12","viewBox":"0 0 8 12","fill":"none"},"body":"\n    <path d=\"M1 1L6 6L1 11\" stroke=\"black\" stroke-width=\"2\" stroke-linecap=\"round\"/>\n"},
	...
	"phone": {"attrs":{"xmlns":"http://www.w3.org/2000/svg","width":"20","height":"20","viewBox":"0 0 20 20","fill":"none"},"body":"\n    <path\n        d=\"M5.2 2.4C4.4 2.4 3.7 2.9 3.5 3.7L2.5 7.1C2.3 7.8 2.5 8.6 3 9.1C5.1 11.5 7.4 13.8 10.9 15.5C11.6 15.9 12.4 15.8 13 15.4L16 13.5C16.7 13.1 17 12.2 16.7 11.4L15.8 9.2C15.5 8.5 14.7 8.1 13.9 8.3L11.6 8.8C11.1 8.9 10.6 8.8 10.2 8.5L7.5 5.8C7.2 5.4 7.1 4.9 7.2 4.4L7.7 2.4H5.2Z\"\n        fill=\"currentColor\"\n    />\n"},
