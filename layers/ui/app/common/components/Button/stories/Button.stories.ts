...
export const States: Story = {
	args: {
		...
		iconRight: iconNames.chevronRight,
	},
	parameters: {
		pseudo: {
	...
	render: (args: ButtonStoryArgs) => {
		...
		return {
			...
			setup() {
				return { args, buttonVariants, updateArgs }
			},
			template: `
						...
						>
							<StoryGridRow>
								<StoryGridItem title="default">
									<Button v-bind="args" :variant="variant" :icon-left="undefined" :icon-right="undefined" />
									<Button v-bind="args" :variant="variant" :icon-left="args.iconLeft" :icon-right="undefined">
										{{ args.text }}
									</Button>
									<Button v-bind="args" :variant="variant" :icon-left="undefined" :icon-right="args.iconRight">
										{{ args.text }}
									</Button>
									<Button v-bind="args" :variant="variant" text="" :icon-left="args.iconLeft" :icon-right="undefined" aria-label="Добавить" />
								</StoryGridItem>
								<StoryGridItem title="hover">
									<Button v-bind="args" :variant="variant" :icon-left="undefined" :icon-right="undefined" class="button-story--hovered" />
									<Button v-bind="args" :variant="variant" :icon-left="args.iconLeft" :icon-right="undefined" class="button-story--hovered">
										{{ args.text }}
									</Button>
									<Button v-bind="args" :variant="variant" :icon-left="undefined" :icon-right="args.iconRight" class="button-story--hovered">
										{{ args.text }}
									</Button>
									<Button v-bind="args" :variant="variant" text="" :icon-left="args.iconLeft" :icon-right="undefined" class="button-story--hovered" aria-label="Добавить" />
								</StoryGridItem>
								<StoryGridItem title="focus">
									<Button v-bind="args" :variant="variant" :icon-left="undefined" :icon-right="undefined" class="button-story--focused" />
									<Button v-bind="args" :variant="variant" :icon-left="args.iconLeft" :icon-right="undefined" class="button-story--focused">
										{{ args.text }}
									</Button>
									<Button v-bind="args" :variant="variant" :icon-left="undefined" :icon-right="args.iconRight" class="button-story--focused">
										{{ args.text }}
									</Button>
									<Button v-bind="args" :variant="variant" text="" :icon-left="args.iconLeft" :icon-right="undefined" class="button-story--focused" aria-label="Добавить" />
								</StoryGridItem>
								<StoryGridItem title="disabled">
									<Button v-bind="args" :variant="variant" disabled :icon-left="undefined" :icon-right="undefined" />
									<Button v-bind="args" :variant="variant" disabled :icon-left="args.iconLeft" :icon-right="undefined">
										{{ args.text }}
									</Button>
									<Button v-bind="args" :variant="variant" disabled :icon-left="undefined" :icon-right="args.iconRight">
										{{ args.text }}
									</Button>
									<Button v-bind="args" :variant="variant" disabled text="" :icon-left="args.iconLeft" :icon-right="undefined" aria-label="Добавить" />
								</StoryGridItem>
							</StoryGridRow>
						</StoryGridSection>
					</StoryGrid>
